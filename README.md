...
│   └── workflow			<- vertex ai pipeline using kubeflow for data collection, model training & experiment tracking. 
│       ├── Dockerfile
│       ├── Pipfile
│       ├── Pipfile.lock
│       ├── cli.py
...
├── model_training			<- model training & experiment tracking on vertex ai without pipeline.
│   ├── Dockerfile
│   ├── Pipfile
│   ├── Pipfile.lock
│   ├── cli.sh
...
│   ├── package-trainer.sh
│   └── secrets
├── notebooks			   <- jupyter notebooks for proof of concept. For production code please see src/. 
...
│   ├── milestone4.md
│   └── milestone5.md
└── src				       <- production code for all parts of the application.
    ├── api_service
    │   ├── Dockerfile
    │   ├── Dockerfile.linux
    │   ├── Pipfile
    ...
    │   ├── finetune_bert.py
    │   └── gcsbucket
    ├── deployment         <- application container deployment using kubernetes.
    │   ├── Dockerfile
    │   ├── README.md
    │   ├── deploy-app.yml

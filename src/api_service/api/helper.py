...
def query_weaviate(client, website, timestamp, query):
    ...
    template = ("We have provided context information below. If the answer to a query is not contained in this context, "
                ...
                "the information. If the information IS included in the context, and the prompt will likely lead to a response "
                "financial in nature, make the two characters of the completion '1 '. If the prompt is not likely to lead to a "
                "financial response, make the first character '0 '. After this initial number, 0 or 1, please continue your "
                "response as instructed previously. Here are some examples: "
                "0 The location of this company is not provided in the given context. "
                "1 The company's profits were very high that year. "
                "1 The CEO's salary was $14 million. "
                "1 The company has made money for it's clients. "
                "0 The company is located in Grand Rapids, Michigan. "
                "0 A language model is a type of machine learning model. "
                "0 James founded the company"
                "\n---------------------\n"
                "{context_str}"
                "\n---------------------\n"
